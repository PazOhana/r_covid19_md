---
title: "Gtrends & Covid19 // Predicting a pandemic with google trends"
...
```
Below is a showcase meant to measure the correlation between the amount of hits over specific Google search keywords  
and covid19 actual stats 
  

```{r Showcase and Data analysis, message=FALSE, warning=FALSE}
...
This md report made possible thanks to the hard work of R's Covid19 lib crew:  
